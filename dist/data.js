...
class ProjectState {
    ...
    buildingPosts() {
        ...
        this.cards = [this.card1, this.card2, this.card3, this.card4, this.card5, this.card6];
    }
    addPosts() {
