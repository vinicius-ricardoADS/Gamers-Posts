...
class ProjectState {
    ...
    private buildingPosts() {
        this.card1 = new Card(Math.random(), 'Valorant', 
        ...
        this.card2 = new Card(Math.random(), 'Call of Duty', 
        ...
        this.card3 = new Card(Math.random(), 'Minecraft', 
        ...
        this.card4 = new Card(Math.random(), 'Spider-Man', 
        ...
        this.card5 = new Card(Math.random(), 'God of War', 
        ...
        this.card6 = new Card(Math.random(), 'League of Legends', 
