...
class ProjectState {
    ...
    private buildingPosts() {
        this.card1 = new Card(1, 'Valorant', 
        ...
        this.card2 = new Card(2, 'Call of Duty', 
        ...
        this.card3 = new Card(3, 'Minecraft', 
        ...
        this.card4 = new Card(4, 'Spider-Man', 
        ...
        this.card5 = new Card(5, 'God of War', 
        ...
        this.card6 = new Card(6, 'League of Legends', 
