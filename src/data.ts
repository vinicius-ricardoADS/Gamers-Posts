...
class ProjectState {
    ...
    private buildingPosts() {
        ...
        const card3 = new Card(3, 'Minecraft', 
            'assets/mine.avif', 'Minecraft is asurvival sandbox video game created by Swedish developer Markus "Notch" Persson and later developed and published by Mojang Studios , whose intellectual property was acquired by Microsoft in 2014.' +
